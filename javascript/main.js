...
let multiTaut = 'You cannot end a sentence with because because because is a conjunction';
console.log(multiTaut.indexOf('because'));

// 18. Use lastIndexOf to find the position of the last occurrence of the word because in the following sentence:'You cannot end a sentence with because because because is a conjunction'
console.log(multiTaut.lastIndexOf('because'));

// 19. Use search to find the position of the first occurrence of the word because in the following sentence:'You cannot end a sentence with because because because is a conjunction'
console.log(multiTaut.search('because'));

// 20. Use trim() to remove any trailing whitespace at the beginning and the end of a string.E.g ' 30 Days Of JavaScript '.
let excessSpace = ' 30 Days Of JavaScript ';
console.log(excessSpace.trim());
...
let wordOne = "python";
let wordTwo = "jargon";
let checkerOne = wordOne.includes('on');
let checkerTwo = wordTwo.includes('on');

console.log(checkerOne, checkerTwo);

// 06. I hope this course is not full of jargon. Check if jargon is in the sentence.
let speech = "I hope this course is not full of jargon. Check if jargon is in the sentence.";
console.log(speech.includes('jargon'));
...
let randomMax = Math.floor(Math.random() * wordLength);

console.log(word[randomMax]);
...
console.log(fullSentence.substr(31, 23));
...
let lineOne = 'Love is the best thing in this world. Some found their love and some are still looking for their love.'
console.log(lineOne.match('love'));
...
let lineTwo = 'You cannot end a sentence with because because because is a conjunction';
console.log(lineTwo.match('because'));
...
// const wordsArray = newSentence.split(" ");
...
console.log(annualIncome.match(/\d+/g)); 